...
from app import security  # Import security module for decryption
...
async def test_save_interaction_success(test_db_session):
    ...
    decrypted_prompt = security.decrypt_text(db_prompt_enc)
    decrypted_response = security.decrypt_text(db_response_enc)
